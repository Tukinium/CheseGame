	...
	for (int h = 0; h < 8;h++)
	{
		for (int w = 0; w < 8; w++)
		{
			...
			case GameScene_Class::None:
				break;
			case GameScene_Class::WhitePawn:
			...
			case GameScene_Class::WhiteKing:
				...
				break;
			case GameScene_Class::BlackPawn:
